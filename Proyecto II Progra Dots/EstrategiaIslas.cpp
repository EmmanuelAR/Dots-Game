...
Jugada* EstrategiaIslas::retornarJugada(Elemento* a)
{
	this->setCampo(a);
...
Jugada* EstrategiaIslas::analizarCampo(Elemento* a)
{
	Jugada* jugada = NULL;
	actualizarNoP();
...
Jugada* EstrategiaIslas::buscarJugadaMasCercana()
{
	Jugada* jugada = NULL;
	jugada = cerrarJugada();
	if (jugada) {
...
void EstrategiaIslas::estaArriba()
{
	Jugada* jugada = NULL;
	int cont = 0;
...
void EstrategiaIslas::estaAbajo()
{
	Jugada* jugada = NULL;
	int cont = 0;
	for (int i = 1; i <= f - 2; i += 2) {
...
void EstrategiaIslas::estaDerecha()
{
	Jugada* jugada = NULL;
	int cont = 0;
	for (int i = 1; i <= f - 2; i += 2) {
...
void EstrategiaIslas::estaIzquierda()
{
	Jugada* jugada = NULL;
	int cont = 0;
	for (int i = 1; i <= f - 2; i += 2) {
...
void EstrategiaIslas::agregarPosibilidad(Jugada* a)
{
	if (cant < tam) {
		if (!this->existe(a)) {
...
string EstrategiaIslas::mostrarPosibilidades()
{
	stringstream s;
	for (int i = 0; i < cant; i++) {
...
Jugada* EstrategiaIslas::analizaVector()
{
	Jugada* jugada = NULL;
	int i = 0;
	int j = 0;
...
bool EstrategiaIslas::existe(Jugada* a)
{
	for (int i = 0; i < cant; i++) {
...
void EstrategiaIslas::limpiarVector()
{
	for (int i = 0; i < cant; i++) {
		delete posibilidades[i];
		posibilidades[i] = NULL;
