...
QuincePuntos::QuincePuntos() :CampoAbs()
{
	this->f = 9;
	this->c = 5;
	m = new Elemento * *[f];
...
bool QuincePuntos::insertar(int x, int y, int n)
{
	Elemento* ele = NULL;
...
bool QuincePuntos::insertarNumero(int n)
{
	Elemento* nu = NULL;
	for (int i = 0; i < f; i++) {
		for (int j = 0; j < c; j++) {
...
int QuincePuntos::getTamFila()
{
	return f;
}

int QuincePuntos::getTamColumna()
{
	return c;
}
